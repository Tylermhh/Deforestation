...
public final class Functions
{
    ...
    public static final int DUDE_NUM_PROPERTIES = 8;
    ...
    public static final int DUDE_HEALTH = 7;
    ...
    public static final String SUMMON_KEY = "summon";
    public static final int SUMMON_NUM_PROPERTIES = 5;
    public static final int SUMMON_ID = 1;
    public static final int SUMMON_COL = 2;
    public static final int SUMMON_ROW = 3;
    public static final int SUMMON_ANIMATION_PERIOD = 4;

    public static final String RUINED_LAND_KEY = "ruined_land";


//put first part in background second in entity to avoid unsupported exception
            ...
            String line, WorldModel world, ImageStore imageStore)
    {
        ...
        if (properties.length > 0) {
            switch (properties[PROPERTY_KEY]) {
                case SUMMON_KEY:
                    return world.parseSummon(properties, imageStore);
                case BGND_KEY:
